                ...
                <div class="sidebar-menu">
                    <ul id="accordion-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="submenu">
                                <li><a href="{{ asset('feruzi-shaving-machines/add-super-admin-phone-numbers') }}">Add phone
                                        number</a></li>

                            </ul>

                            <ul class="submenu">
                                <li><a href="{{ asset('feruzi-shaving-machines/view-super-admin-phone-numbers') }}">View phone
                                        numbers</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="submenu">
                                <li><a href="{{ asset('feruzi-shaving-machines/view-total-normal-admin-phone-numbers') }}">View total system admins
                                        </a></li>
