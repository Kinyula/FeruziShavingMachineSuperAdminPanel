...
class ViewSuperAdminPhoneNumbersLivewire extends Component
{
    public function render()
    {
        return view('livewire.view-super-admin-phone-numbers-livewire', ['PhoneNumbers' => PhoneNumber::with(['user'])->where('user_id', auth()->user()->id)->get()]);
    }
